...
import sinkj1.library.repository.AuthorRepository;
import sinkj1.library.service.dto.AuthorDTO;
import sinkj1.library.service.mapper.AuthorMapper;
...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).birthday(DEFAULT_BIRTHDAY);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
        return author;
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.birthday(UPDATED_BIRTHDAY);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
