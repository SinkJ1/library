...
import sinkj1.library.repository.CustomerRepository;
import sinkj1.library.service.dto.CustomerDTO;
import sinkj1.library.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).birthday(DEFAULT_BIRTHDAY);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).birthday(UPDATED_BIRTHDAY);
