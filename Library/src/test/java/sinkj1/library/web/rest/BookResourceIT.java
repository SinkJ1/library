...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).dateOfIssue(DEFAULT_DATE_OF_ISSUE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).dateOfIssue(UPDATED_DATE_OF_ISSUE);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getDateOfIssue()).isEqualTo(DEFAULT_DATE_OF_ISSUE);
    }
    ...
    @Test
    @Transactional
    void checkDateOfIssueIsRequired() throws Exception {
        int databaseSizeBeforeTest = bookRepository.findAll().size();
        // set the field null
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).dateOfIssue(UPDATED_DATE_OF_ISSUE);
        ...
        assertThat(testBook.getDateOfIssue()).isEqualTo(UPDATED_DATE_OF_ISSUE);
    }
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).dateOfIssue(UPDATED_DATE_OF_ISSUE);
