...
export class AuthorComponent implements OnInit {
  ...
  constructor(protected authorService: AuthorService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.authors = [];
    ...
    this.authorService
      ...
      .subscribe(
        (res: HttpResponse<IAuthor[]>) => {
          ...
          this.paginateAuthors(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
  ...
  protected paginateAuthors(data: IAuthor[] | null, headers: HttpHeaders): void {
