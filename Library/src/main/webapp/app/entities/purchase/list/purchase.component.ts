...
export class PurchaseComponent implements OnInit {
  ...
  constructor(protected purchaseService: PurchaseService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.purchases = [];
    ...
    this.purchaseService
      ...
      .subscribe(
        (res: HttpResponse<IPurchase[]>) => {
          ...
          this.paginatePurchases(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
  ...
  protected paginatePurchases(data: IPurchase[] | null, headers: HttpHeaders): void {
